...
and the sources bear that out precisely: the two causal slots are declared on
\texttt{abox-item} but never written or read anywhere in MiDeLoRa, and no marking
algorithm exists. What ships is chronological \texttt{global-rollback} together
with \texttt{sort-choice-points} --- backjumping, not backtracking. The DDB
design remained a design.
